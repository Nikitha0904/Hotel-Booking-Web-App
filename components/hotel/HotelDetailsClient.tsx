    ...
    <div className="flex flex-col gap-6 pb-2">
      ...
      <div>
        ...
        <div className="font-semibold mt-4">
          <AmenityItem><MapPin className="size-4" />{country?.name},{hotel.city}</AmenityItem>
        </div>
        ...
        <h3 className="font-semibold text-xl mt-4 mb-2">About this hotel</h3>
        <p className="text-primary/90 mb-2">{hotel.description}</p>
        <h3 className="font-semibold text-xl mt-4 mb-2">Popular Amenities</h3>
      ...
      <div>
        ...
        {!!hotel.rooms.length && <div>
          <h3 className="text-1g font-semibold my-4">Hotel Rooms</h3>
